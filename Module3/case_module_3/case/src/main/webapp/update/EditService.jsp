                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-outline">
                                        ...
                                        <input type="number" class="form-control" name="number_of_floors"
                                               value="<%=service.getNumber_of_floors()%>"
                                               min="0" required/>
                                    ...
                                    <div class="form-outline">
                                        ...
                                        <input type="text" class="form-control" name="facility_text"
                                               value="<%=service.getFacility_text()%>"
                                               required/>
                                    </div>
